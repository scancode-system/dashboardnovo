...
<div class="modal-body">
	<div class="form-group">
		@if(isset($item))
		{{ Form::text('product_id', $item->product->description, ['class' => 'form-control', 'disabled' => 'disabled']) }}
		@else
	...
	<div id="{{ $modal_id }}_info">
		@if(isset($item))
		@include('dashboard::orders.tabs.items.info', ['product' => $item->product])
		@endif
	</div>
</div>
...
<script>
	...
	$('#select_products').select2({
		dropdownParent: $('#modal_create_order_items'),
		ajax: {
			url: function (params) {
