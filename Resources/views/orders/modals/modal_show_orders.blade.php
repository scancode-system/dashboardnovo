...
<div class="row justify-content-center mb-2">
	...
	<div class="col">{{ $order->client->corporate_name ?? 'N/A' }}</div>
</div>
<div class="row justify-content-center mb-2">
	<div class="col"><strong>Comprador: </strong></div>
	<div class="col">{{ $order->client->buyer ?? 'N/A' }}</div>
</div>
<div class="row justify-content-center mb-2">
	<div class="col"><strong>Representante: </strong></div>
	<div class="col">{{ $order->saller->name ?? 'N/A' }}</div>
</div>
<div class="row justify-content-center mb-2">
	<div class="col"><strong>Status: </strong></div>
	<div class="col"><span class="badge badge-{{ $order->status->color }} badge-pill py-1 px-4">{{ $order->status->name }}</span></div>
</div>
<div class="row justify-content-center mb-2">
