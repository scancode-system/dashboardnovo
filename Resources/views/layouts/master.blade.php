...
<head>
    ...
    <link href="/modules/dashboard2/coreui/dist/vendors/@coreui/chartjs/css/coreui-chartjs.css" rel="stylesheet">
    <style>
        .pagination {
            margin-bottom: 0px;
        }
...
<body class="c-app">
    <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
        <div class="c-sidebar-brand d-lg-down-none">
            <svg class="c-sidebar-brand-full" width="118" height="46" alt="CoreUI Logo">
                <use xlink:href="/modules/dashboard2/coreui/dist/assets/brand/coreui.svg#full"></use>
            </svg>
            <svg class="c-sidebar-brand-minimized" width="46" height="46" alt="CoreUI Logo">
                <use xlink:href="/modules/dashboard2/coreui/dist/assets/brand/coreui.svg#signet"></use>
            </svg>
        </div>
        <ul class="c-sidebar-nav">
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="{{ route('dashboard') }}">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="/modules/dashboard2/coreui/dist/vendors/@coreui/icons/svg/free.svg#cil-speedometer"></use>
                    </svg> Dashboard
                </a>
            </li>
            ...
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="/modules/dashboard2/coreui/dist/vendors/@coreui/icons/svg/free.svg#cil-clipboard"></use>
                    </svg> Pedidos
                </a>
            </li>
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="/modules/dashboard2/coreui/dist/vendors/@coreui/icons/svg/free.svg#cil-tags"></use>
                    </svg> Produtos
                </a>
            </li>
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="/modules/dashboard2/coreui/dist/vendors/@coreui/icons/svg/free.svg#cil-people"></use>
                    </svg> Clientes
                </a>
            </li>
            <li class="c-sidebar-nav-item">
            ...
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="/modules/dashboard2/coreui/dist/vendors/@coreui/icons/svg/free.svg#cil-spreadsheet"></use>
                    </svg> Relatórios
                </a>
            </li>
        ...
        <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
            <button class="c-header-toggler c-class-toggler d-lg-none mfe-auto" type="button" data-target="#sidebar" data-class="c-sidebar-show">
                <svg class="c-icon c-icon-lg">
                    <use xlink:href="/modules/dashboard2/coreui/dist/vendors/@coreui/icons/svg/free.svg#cil-menu"></use>
                </svg>
                ...
                <li class="c-header-nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right pt-0">
                        ...
                        {{ Form::button('<svg class="c-icon mr-2">
                                <use xlink:href="/modules/dashboard2/coreui/dist/vendors/@coreui/icons/svg/free.svg#cil-account-logout"></use>
    ...
    <script src="/modules/dashboard2/coreui/dist/vendors/@coreui/chartjs/js/coreui-chartjs.bundle.js"></script>
    <script src="/modules/dashboard2/coreui/dist/vendors/@coreui/utils/js/coreui-utils.js"></script>
    <script
